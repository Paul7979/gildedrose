...
public class TestCasesProvider {
    static Stream<Arguments> provideItemsAndExpectedResults() {
        ...
        return Stream.of(
                ...
                Arguments.of("Brie10SellIn10QualityIncreasedBy12",new Item(GildedRose.AGED_BRIE, initialSellInMinus10, initialQuality10), new Item(GildedRose.AGED_BRIE, initialSellInMinus10 - 1, initialQuality10 + 2)),
