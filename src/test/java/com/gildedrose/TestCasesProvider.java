...
public class TestCasesProvider {
    static Stream<Arguments> provideItemsAndExpectedResults() {
        ...
        return Stream.of(
                ...
                Arguments.of("Brie10SellIn10QualityPlus1Quality",new Item(GildedRose.AGED_BRIE, initialSellIn10, initialQuality10), new Item(GildedRose.AGED_BRIE, initialSellIn10 - 1, initialQuality10 + 1)),
                Arguments.of("Brie10SellIn50QualityStaysUnchanged",new Item(GildedRose.AGED_BRIE, initialSellIn10, initialQuality50), new Item(GildedRose.AGED_BRIE, initialSellIn10 - 1, initialQuality50)),
                Arguments.of("BrieMinus10SellIn10QualityIncreasedBy2",new Item(GildedRose.AGED_BRIE, initialSellInMinus10, initialQuality10), new Item(GildedRose.AGED_BRIE, initialSellInMinus10 - 1, initialQuality10 + 2)),
                Arguments.of("Brie5SellIn10QualityIncreasedBy1",new Item(GildedRose.AGED_BRIE, initialSellIn5, initialQuality10), new Item(GildedRose.AGED_BRIE, initialSellIn5 - 1, initialQuality10 + 1)),
                Arguments.of("Brie0SellIn10QualityIncreasedBy2",new Item(GildedRose.AGED_BRIE, initialSellIn0, initialQuality10), new Item(GildedRose.AGED_BRIE, initialSellIn0 - 1, initialQuality10 + 2)),
                ...
                Arguments.of("Backstage10SellIn0QualityPlus2Quality",new Item(GildedRose.BACKSTAGE_PASSES_FOR_CONCERT, initialSellIn10, initialQuality0), new Item(GildedRose.BACKSTAGE_PASSES_FOR_CONCERT, initialSellIn10 - 1, initialQuality0 + 2)),
                Arguments.of("Backstage5SellIn0QualityPlus3Quality",new Item(GildedRose.BACKSTAGE_PASSES_FOR_CONCERT, initialSellIn5, initialQuality0), new Item(GildedRose.BACKSTAGE_PASSES_FOR_CONCERT, initialSellIn5 - 1, initialQuality0 + 3)),
                ...
                Arguments.of("Backstage20SellIn10QualityPlus1Quality",new Item(GildedRose.BACKSTAGE_PASSES_FOR_CONCERT, initialSellIn20, initialQuality10), new Item(GildedRose.BACKSTAGE_PASSES_FOR_CONCERT, initialSellIn20 - 1, initialQuality10 + 1))
        );
    }
}
